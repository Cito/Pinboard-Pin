...
Pinboard Pin is a web extension for pinning pages on [Pinboard](https://pinboard.in) with Firefox.
...
You can install the extension using the [Mozilla Add-ons](https://addons.mozilla.org/firefox/addon/pinboard-pin/) page.
...
* Follow the instructions outlined in [DEVELOP.md](https://github.com/cito/Pinboard-Pin/blob/main/DEVELOP.md) if you want to build this extension on your own or run it in development mode.
...
* [Pinboard Archive](https://github.com/Cito/Pinboard-Archive) - A tool for making your Pinboard bookmark export searchable and filterable, without needing the Pinboard service.
