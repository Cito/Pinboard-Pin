...
* The PinPageComponent was much too big; its tag handling has since been extracted into a separate TaggingComponent. It could be slimmed down further by moving the remaining form fields into a single object (or Angular Signal Forms), similar to the OptionsComponent.
